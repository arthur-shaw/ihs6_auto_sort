...
local qnrName 		=	"IHS6 Cross_Section" 	// questionnaire title--that is, title, not questionnaire variable
...
local hhold 		"Cross_Section.dta"
local members 		"hhroster.dta"
...
local plotsDimba 	"ag_J_plot_roster.dta"
local plotsPerm 	"ag_o_2_plot_roster.dta"
local salesRainy 	"ag_H_seed_roster.dta"
local salesDimba 	"ag_n_seeds_roster.dta"
local salesPerm 	"ag_Q_storage_roster.dta"
