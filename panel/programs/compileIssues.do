...
createComplexIssue , 	///
	attributesFile(`attributesPath') ///
	issuesFile(`issuesPath') ///
	whichAttributes(numFoodItems panelA) ///
	issueCondit(numFoodItems == 0 & panelA == 1) ///
	issueType(1) ///
...
createComplexIssue , ///
	attributesFile(`attributesPath') ///
	issuesFile(`issuesPath') ///
	whichAttributes(caloriesTooHigh panelA) ///
	issueCondit(caloriesTooHigh == 1 & panelA == 1) ///
	issueType(1) ///
...
createComplexIssue , ///
	attributesFile(`attributesPath') ///
	issuesFile(`issuesPath') ///
	whichAttributes(caloriesTooLow panelA) ///
	issueCondit(caloriesTooLow == 1 & panelA == 1) ///
	issueType(1) ///
...
createComplexIssue , ///
	attributesFile(`attributesPath') ///
	issuesFile(`issuesPath') ///
	whichAttributes(highItemCalories panelA) ///
	issueCondit(highItemCalories == 1 & panelA == 1) ///
	issueType(1) ///
...
INCOME
-----------------------------------------------------------------------------*/
* do not get a complete picture of income in a single panel visit
* in particular, missing: crop sales, and wage and enterprise income for panel B
/*
* no income
#delim ;
local incomeVars "
...
createComplexIssue , ///
	...
	issuesFile(`issues') ///
	whichAttributes(worksInNFE numEnterprises panelA) ///
	issueCondit(worksInNFE == 1 & numEnterprises == 0 & panelA == 1) ///
	issueType(1) ///
...
createComplexIssue , ///
	attributesFile(`attributes') ///
	issuesFile(`issues') ///
	whichAttributes(worksInAg doesAgriculture panelA) ///
	issueCondit(worksInAg == 1 & doesAgriculture == 0 & panelA == 1) ///
	issueType(1) ///
...
createComplexIssue , ///
	attributesFile(`attributes') ///
	issuesFile(`issues') ///
	whichAttributes(worksInLivestock ownsLivestock panelA) ///
	issueType(1) ///
	issueCondit(worksInLivestock == 1 & ownsLivestock == 0 & panelA == 1) ///
...
createComplexIssue , ///
	attributesFile(`attributes') ///
	issuesFile(`issues') ///
	whichAttributes(worksInFisheries doesFishing panelA) ///
	issueType(1) ///
	issueCondit(worksInFisheries == 1 &  doesFishing == 0 & panelA == 1) ///
